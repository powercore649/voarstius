...
const rows = [
  { keys: '?', desc: 'Ouvrir ce panneau de raccourcis (hors champ de saisie)' },
  { keys: 'Esc', desc: 'Fermer ce panneau ou le menu profil' },
  { keys: 'Ctrl K', desc: 'Ouvrir la recherche globale' },
  { keys: 'G + O', desc: 'Aller à Overview' },
  { keys: 'G + M', desc: 'Aller à Moderation' },
  { keys: 'G + A', desc: 'Aller à Analytics' },
  { keys: 'G + S', desc: 'Aller à Bot Status' },
  { keys: 'G + C', desc: 'Aller à Command Center' },
];
